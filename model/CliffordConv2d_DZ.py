...
class Net(nn.Module):
    ...
    def forward(self, wide, deep):
        ...
        for i in range(len(ahead_times)):
            ...
            # print("deep_P",deep_P.shape)
            # 将压强层变换至index=1的位置
            deep_P = deep_uv.permute(0, 2, 3, 4,1)  # 96,4,31,31,2
            # 2、split 1
            ...
            time_seq_1 = self.cli_att_block_2(time_seq_1) * time_seq_1  # 96,64,7,7,2
            ...
            time_seq_2 = self.cli_att_block_3(time_seq_2) * time_seq_2  # 96,128,3,3,2
            ...
            time_seq = self.cli_att_block_3(time_seq) * time_seq  # 96,128,3,3,2
